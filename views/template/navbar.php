            ...
            <ul class="navbar-nav align-items-center ms-auto mb-2 mb-lg-0">
                ...
                <?php } else { ?>
                    ...
                    <?php } else { ?>
                        ...
                        ?>" class="nav-link" href="/thesis/home">News / Announcements / Events</a></li>
                        <li class="nav-item"><a style="<?php
                        if (str_contains($url, "/thesis/contents/gallery")) {
                            echo "color: white";
                        }
                        ?>" class="nav-link" href="/thesis/contents/gallery/all">Gallery</a></li>
                        <li class="nav-item"><a style="<?php
                        if (str_contains($url, "/thesis/surveys")) {
                            echo "color: white";
                        }
                        ?>" class="nav-link" href="/thesis/surveys/answers">Survey</a></li>
                        <li class="nav-item"><a style="<?php
                        if (str_contains($url, "/thesis/alumni")) {
                            echo "color: white";
                        }
                        ?>" class="nav-link" href="/thesis/search/alumni">Search Alumni</a></li>
