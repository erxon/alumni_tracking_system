                ...
                <?php } else { ?>
                    ...
                    <?php } else { ?>
                        ...
                        <li class="nav-item dropdown">
                            ...
                            <ul class="dropdown-menu">
                                <li><a style="<?php
                                                ...
                                                ?>" class="dropdown-item" href="/thesis/contents/gallery/all">Gallery</a></li>
                                <li><a style="<?php
                                                if (str_contains($url, "/thesis/surveys")) {
                                                    echo "background-color: #028fed; border: 0px; color: #fff";
                                                }
                                                ?>" class="dropdown-item" href="/thesis/surveys/answers">Survey</a></li>
                                <li><a style="<?php
                                                if (str_contains($url, "/thesis/contents/news/all")) {
                                                    echo "background-color: #028fed; border: 0px; color: #fff";
                                                }
                                                ?>" class="dropdown-item" href="/thesis/contents/news/all">News</a></li>
                                <li><a style="<?php
                                                if (str_contains($url, "/thesis/contents/events/all")) {
                                                    echo "background-color: #028fed; border: 0px; color: #fff";
                                                }
                                                ?>" class="dropdown-item" href="/thesis/contents/events/all">Events</a></li>
                            </ul>
                        </li>
                        ...
                        <li class="nav-item"><a role="button" class="btn btn-sm btn-light" style="<?php
                                                                                                    ...
                                                                                                    ?>" class="nav-link" href="/thesis/search/alumni"><i class="fas fa-search"></i> Search Alumni</a></li>
                        <li class="nav-item dropdown">
                            <a style="<?php
