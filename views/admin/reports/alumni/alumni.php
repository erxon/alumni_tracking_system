...
<div>
    <div class="d-flex align-items-center">
        <button id="alumni-records-print" class="btn btn-sm btn-dark me-3">Print</button>
        <div style="display: none" id="printing-spinner" class="spinner-border text-dark" role="status">
            <span class="visually-hidden">Loading...</span>
        </div>
    </div>
    <div id="alumni-records-report">
        <div class="mb-2">
            ...
            <div class="collapse" id="graph-4">
                <div class="row">
                    ...
                    <div class="col-4">
                        <table class="table">
                            <thead>
                                <?php foreach ($alumniAccordingToGender as $gender) { ?>
                                    <th><?php echo $gender["label"]; ?></th>
                                <?php } ?>
                            </thead>
                            <tbody>
                                <tr>
                                    <?php foreach ($alumniAccordingToGender as $gender) { ?>
                                        <td><?php echo $gender["y"]; ?></td>
                                    <?php } ?>
                                </tr>
                            </tbody>
                        </table>
