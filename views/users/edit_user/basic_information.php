...
<form id="basic-information">
    ...
    <button data-bs-toggle="modal" data-bs-target="#basic-information-save-confirm" type="button"
        class="btn btn-sm btn-outline-dark" name="basic_information">Save</button>
    <div class="modal fade" id="basic-information-save-confirm" tabindex="-1" aria-labelledby="exampleModalLabel"
        aria-hidden="true">
