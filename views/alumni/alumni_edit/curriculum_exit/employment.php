...
$curriculumExitEmployment = $alumni->getCurriculumExitEmployment($id);

$workLocation = $curriculumExitEmployment["workLocation"];
$region = $curriculumExitEmployment["region"];
$municipality = $curriculumExitEmployment["municipality"];
$city = $curriculumExitEmployment["city"];
$details = $curriculumExitEmployment["details"];

$country = $curriculumExitEmployment["country"];
...
$jobIndustry = $curriculumExitEmployment["jobIndustry"];
$orgType = $curriculumExitEmployment["orgType"];
$employmentType = $curriculumExitEmployment["employmentType"];
$jobLevel = $curriculumExitEmployment["jobLevel"];
$companyName = $curriculumExitEmployment["companyName"];
$companyContact = $curriculumExitEmployment["companyContact"];
$dateHired = $curriculumExitEmployment["dateHired"];
$workSetup = $curriculumExitEmployment["workSetup"];
$salaryRange = $curriculumExitEmployment["salaryRange"];
...
<form id="curriculum-exit-employment">
    <div class="mt-2">
        ...
        <div class="collapse my-2" id="work-location-local">
            <div class="d-flex mb-2">
                <div class="form-floating flex-fill me-2">
                    <input id="region" name="region" class="form-control" placeholder="Region" value="<?php echo $region ?>" />
                    <label for="region">Region</label>
                </div>
                <div class="form-floating flex-fill me-2">
                    <input id="municipality" name="municipality" class="form-control" placeholder="Municipality" value="<?php echo $municipality ?>" />
                    <label for="municipality">Municipality</label>
                </div>
                <div class="form-floating flex-fill">
                    <input id="city" name="city" class="form-control" placeholder="City" value="<?php echo $city; ?>" />
                    <label for="city">City</label>
                </div>
            </div>
            <div class="form-floating flex-fill">
                <input id="details" name="details" class="form-control" placeholder="Details" value="<?php echo $details ?>" />
