        ...
        <div class="col-6 mb-2">
            ...
            if ($additionalInfoField[3] == "user_defined") { ?>
                <div class="form-floating">
                    <input name="field-<?php echo $increment; ?>" id="<?php echo $additionalInfoField[0] ?>"
                        type="text" placeholder="<?php echo $additionalInfoField[1]; ?>"
                        class="form-control additional-field <?php if ($additionalInfoField[2] == "date") {
                            echo "datepicker";
                        } ?>"
                        value="" />
            ...
            <?php } else if ($additionalInfoField[3] == "multiple_choice") { ?>
                    <div class="form-floating">
                        <select name="field-<?php echo $increment; ?>" id="<?php echo $additionalInfoField[0]; ?>"
                            ...
                            foreach ($choices as $choice) { ?>
                                <option value="<?php echo $choice["choiceName"]; ?>">
                                <?php echo $choice["choiceName"] ?>
                                </option>
                        <?php } ?>
                        </select>
                        <label class="mb-2"
                            for="<?php echo $additionalInfoField[0]; ?>"><?php echo $additionalInfoField[1]; ?></label>
                    </div>
            <?php } ?>
        </div>
        <?php $increment++; ?>
