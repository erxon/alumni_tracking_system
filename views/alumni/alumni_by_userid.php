...
if ($_SERVER["REQUEST_METHOD"] == "GET") {
    ...
    $alumniDetails = $alumni->getAlumniByUserId($id);
...
<div class="main-body-padding w-75 mx-auto alumni-profile">
    <a href="<?php if ($alumniDetails["status"] == "pending") {
                    ...
                    echo "/thesis/users?id=".$alumniDetails["userAccountID"];
                } ?>" role="button" class="btn btn-sm btn-outline-dark mb-3"><i class="fas fa-arrow-left"></i> Back</a>
    <div class="row">
        <div class="col-4">
            <!--Photo-->
