        ...
        <div class="row mb-4">
            <?php foreach ($surveys as $survey) { ?>
                <div class="card m-2 col-md-4 p-0" style="width: 16rem;">
                    <img style="height: 10rem; width: auto; object-fit: cover;" src="/thesis/public/images/cover/<?php echo $survey[6]; ?>" class="card-img-top">
                    <div class="card-body">
                        <h5 class="card-title"><?php echo $survey[1]; ?></h5>
                        ...
                        <p class="card-text"><?php
                                                $author = $content->getAuthor($survey[3]);
