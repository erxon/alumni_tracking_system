...
<div class="main-body-padding mt-5">
    <div class="container w-50 m-auto bg-white p-3 rounded shadow">
        ...
        <form action="/thesis/contents/surveys/submit" enctype="multipart/form-data" method="post" id="surveys-form" class="surveys-form">
            <div class="mb-3">
                <!-----Survey Body----->
                ...
                <textarea name="description" id="content-body" class="form-control"></textarea>
            </div>
